...
<body>
    ...
    <div class="sequence">
      ...
      <div class="seq-preloader">
          ...
          <div class="slide" id="1">
            <div class="content first-content">
              <div class="container-fluid">
                  <div class="col-md-3">
                      <div class="author-image"><img src="img/profile.jpg" alt="Author Image"></div>
                  </div>
                  <div class="col-md-9">
                      <h2>Rakesh Chaudhary</h2>
        ...
        <div class="footer">
          <div class="content">
              <p>Copyright &copy; 2020 Rakesh Chaudhary <a rel="nofollow" href="h">Rakesh Chaudhary</a></p>
          </div>
        </div>
